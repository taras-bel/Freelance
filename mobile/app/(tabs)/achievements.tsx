    ...
    <GradientBackground>
      ...
      >
        <View glass style={styles.glassPanel}>
          <Text style={styles.title} accentColor="violet">Достижения</Text>
          {loading ? (
            ...
            <EmptyOrError
              ...
              description="Выполняйте задачи и получайте достижения!"
              accent="teal"
            />
          ) : (
            <>
              ...
              <Text style={styles.achTitle} accentColor="teal">Ваши достижения</Text>
              {achievements.map((ach, i) => (
                <View key={ach.id || i} style={styles.achCard} glass>
                  <Text style={styles.achName} accentColor="cyan">{ach.name}</Text>
                  <Text style={styles.achDesc}>{ach.description}</Text>
                  <Text style={styles.achDate}>{ach.date || ach.achieved_at}</Text>
                </View>
              ))}
            </>
          )}
